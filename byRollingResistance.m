% Simulações Com controle - Resistencia de rolamento variável
...
for q=1:size(Simulations,1)
	...
	Person.Controller{q}.Frr = Simulations(q);
...
save([cd,'\Results\','byRollingResistance_Indice',int2str(Indice),'_SteadyState','.mat'],'Results','Person','ReferenceModel','Options','Simulations')
...
save([cd,'\Results\','byRollingResistance_Indice',int2str(Indice),'_EnergeticRace','.mat'],'Results','Person','ReferenceModel','Options','Simulations')
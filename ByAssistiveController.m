...
save([cd,'\Results\','byAssistiveController_Indice',int2str(Indice),'_SteadyState','.mat'],'Results','Person','ReferenceModel','Options','Simulations')
...
save([cd,'\Results\','byAssistiveController_Indice',int2str(Indice),'_EnergeticRace','.mat'],'Results','Person','ReferenceModel','Options','Simulations')